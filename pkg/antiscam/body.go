...
func checkComment(body string, comment_author string) []Detection {
	...
	if !whitelisted_logins[strings.ToLower(comment_author)] {
		...
		if strings.Contains(body_lower_case, ".web.app") || strings.Contains(body_lower_case, "outlook.com") || (((strings.Contains(body_lower_case, "https://") || strings.Contains(body_lower_case, ".com")) &&
